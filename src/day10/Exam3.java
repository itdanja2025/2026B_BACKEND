...
public class Exam3 {
    public static void main(String[] args) {
        ...
        // 2. 하위객체
        하위클래스 obj2 = new 하위클래스(); // 하위 메소드가 재정의 실행
        obj2.show();
        System.out.println( obj2.value1 );
        System.out.println( obj2.value3 );

        // 3. *타입변환*
        상위클래스 obj3 = obj2; // 하위 메소드가 재정의 실행
        obj3.show();
